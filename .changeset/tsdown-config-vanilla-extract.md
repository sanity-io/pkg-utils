...
The feature is fully opt-in: `@vanilla-extract/rollup-plugin` is an optional peer dependency, and neither it nor the CSS toolchain is loaded unless `vanillaExtract` is enabled.
